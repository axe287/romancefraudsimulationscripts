...
# ---------------------------
# All simulations were generated with similar scripts, only the generate_gemini_response & generate_gpt4o_mini_response functions had to be edited, the function names were kept the same with the contents edited per LLM combination wanted
# 2nd NEW OpenAI API key!!! - Insert OpenAI key here
openai.api_key = ''
...
def generate_gemini_response(prompt):
    """
    Generate a response using GPT4omini model.
    """
    try:
